                ...
                <div class="popup" id="popup--filters">
                    <div class="popup__content">
                        ...
                        <div class="field is-centered row">
                            <label for="filter--votes" class="column is-5">Minimum votes</label>
                            <div class="column is-4">
                                <input type="text" id="filter--votes" name="filter--votes" value="2000">
                            </div>
                        </div>
                        <div class="field is-centered row">
                            <label for="filter--score" class="column is-5">Minimum score</label>
                            <div class="column is-4">
                        ...
                        <input type="checkbox" class="checkbox" id="filter__list--not" checked>
                        <label for="filter__list--not">Not in my list</label>
                        <input type="checkbox" class="checkbox" id="filter__list--watching" checked>
                        <label for="filter__list--watching">Watching</label>
                        <input type="checkbox" class="checkbox" id="filter__list--ptw" checked>
                        <label for="filter__list--ptw">PTW</label>
                        <input type="checkbox" class="checkbox" id="filter__list--completed" checked>
                        <label for="filter__list--completed">Completed</label>
                        <input type="checkbox" class="checkbox" id="filter__list--dropped" checked>
                        <label for="filter__list--dropped">Dropped</label>
                        <div class="field popup__confirm">
