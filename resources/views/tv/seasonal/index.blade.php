...
@section('content')
  ...
  <div id="app">
    <div class="filters has-depth-1">
      <div class="container">
        ...
        <div class="filters__list is-right">
          <div class="toggle">
            <input type="checkbox" @click="filterSequels" v-model="checkSequels" id="filter__sequels" name="filter__sequels">
    ...
    <main class="seasonal">
      <div class="container">
        <div class="row is-multiline">
          <tv_season v-for="tv_season in filtered" :key="tv_season.id" :season="season" :tv_season="tv_season"></tv_season>
        </div>
      </div>
    </main>
  </div>
