    ...
    <div class="card">
      <div class="card-content">
        <div class="card__head">
          ...
          <span class="head__page text-{{ lcfirst($currentSeason->name) }}">Notification Settings</span>
        </div>
        <div class="content__notifications--text">
        ...
        <div class="content__notifications--options card-meta">
          <form method="POST" action="{{ route('users.settings.notifications') }}">
            ...
            <div class="button-group">
              <button type="submit" class="button is-{{ lcfirst($currentSeason->name) }}">Save</button>
