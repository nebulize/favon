...
class ListService
{
    ...
    public function updateTvShowListStatus(User $user, TvSeason $tvSeason, ?array $values): void
    {
        ...
        if ($status === ListStatus::STATUS_COMPLETED) {
            if (($tvShow->tv_status_id === TvStatus::ENDED || $tvShow->tv_status_id === TvStatus::CANCELED)
